...
class BlockCurrenciesDropdown extends Module
{
	public function __construct()
	{
		$this->name = 'blockcurrenciesdropdown';
	...
	*/
	public function hookTop($params)
	{
		if ($this->_prepareHook($params))
			return $this->display(__FILE__, 'blockcurrenciesdropdown.tpl');
	}
	...
	public function hookHeader($params)
	{
		if (Configuration::get('PS_CATALOG_MODE'))
			return;
		$this->context->controller->addCSS(($this->_path).'blockcurrenciesdropdown.css', 'all');
	}
}
